...
function anonymousFunction() {
    ...
    return function ModelCreator(modelName){
        var constModel = {};
        ...
        this.addChildModel = function(childModel) {
            ...
            console.log('before');
            console.log(constModel.children);
            console.log('adding: '+childModel.propertyName);
        ...
        this.finaliseModel = function() {
            ...
            // console.log('finilizing : '+constModel);
            console.log('finilizing: ');
            console.log(constModel);
