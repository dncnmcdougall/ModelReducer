...
describe('VersioningCreator: A class used in validating to allow different versions of an object.', function() {
    ...
    describe('addVersion: adds a version.', function() {
    ...
    describe('lastVersionNumber: largest version number in this versioning.', function() {
    ...
    describe('Version: the class representing a particular version.', function() {
        ...
        describe('rename: specifies a property rename for a version', function(){
